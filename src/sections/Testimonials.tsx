    ...
    <div className="py-16">
      <div className="container">
        <SectionHeader eyebrow="Happy Clients" title="What Clients say about Me"
          desc="Don't just take my word for it. See what my client have to say about my work."
        />
                    ...
                    <Card key={test.name} className="max-w-xs md:p-8 p-6 md:max-w-md hover:-rotate-3 transition duration-300">
                      <div className="flex gap-4 items-center">
                        <div className="size-14 bg-gray-700 inline-flex items-center justify-center rounded-full flex-shrink-0">
                          <Image src={test.avatar} alt="testimonial" className="max-h-full" />
                        </div>
                        <div>
                      ...
                      <p className="text-sm mt-4 md:mt-6 md:text-base">{test.text}</p>
                    </Card>
                  ))
                }
              </Fragment>
